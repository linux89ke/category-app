...
            cols[i % 3].markdown(f"- **{top}** ({count:,} leaves)") remove emojis make it proffesional also im uploading category_map1 the category file to script folder so no uploading every time 
