...
_TECH_NOISE = {
    ...
    'tpu', 'magsafe', 'nfc', 'matte',  # phone case material noise
}
_FILLER = {
...
_EXPANSIONS = {
    ...
    'airpods':      'earphones headphones wireless earbuds',
    'spacebuds':    'earphones headphones wireless earbuds',
...
# Synthetic keywords injected into the taxonomy index for categories whose
# plain keywords are too sparse to match real product names.
# These are added AT INDEX BUILD TIME — not to queries.
_SYNTHETIC_CATEGORY_KW = {
    'Phones & Tablets / Accessories / Cases':
        'phone cover protective tpu silicone flip magsafe smartphone mobile case cover',
    'Phones & Tablets / Accessories / Cases / Cases':
        'phone cover protective tpu silicone flip magsafe smartphone mobile case cover',
    'Phones & Tablets / Accessories / Cases / Flip Cases':
        'phone flip cover folio protective case smartphone mobile',
    'Phones & Tablets / Accessories / Cases & Clips':
        'phone cover protective case smartphone mobile clip belt holster',
    'Phones & Tablets / Accessories / Cases & Clips / Cases':
        'phone cover protective tpu silicone case smartphone mobile',
    'Phones & Tablets / Accessories / Screen Protectors':
        'phone screen glass tempered protector smartphone mobile privacy film',
    'Phones & Tablets / Accessories':
        'phone smartphone mobile charger cable accessories iphone samsung galaxy redmi',
    'Phones & Tablets / Accessories / USB Sync & Charging':
        'phone charger cable usb fast charging power adapter smartphone',
    'Phones & Tablets / Accessories / USB Sync & Charging / Chargers & Adapters':
        'phone charger adapter usb fast charging watt samsung galaxy wall plug',
    'Phones & Tablets / Accessories / Bluetooth Headsets':
        'wireless earbuds airpods earphones headphones bluetooth in ear',
    'Electronics / Headphones / Earbud Headphones':
        'wireless earbuds airpods earphones bluetooth in ear true wireless',
}
